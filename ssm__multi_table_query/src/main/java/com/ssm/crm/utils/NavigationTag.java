...
public class NavigationTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        try {
        	...
        	if (page.getPage() > 1) {
                ...
                preUrl = new String(preUrl.getBytes("iso-8859-1"),"utf-8");
            ...
            if (page.getPage() < pageCount) {
                ...
                nextUrl = new String(nextUrl.getBytes("iso-8859-1"),"utf-8");
     ...
     * @throws JspException
     */
    private String resolveUrl(String url, javax.servlet.jsp.PageContext pageContext) throws Exception{
